...
// Source: tdd-ddd-go/cookies (interfaces: CookieStockChecker,CardCharger,EmailSender)
...
func (m *MockEmailSender) SendEmailReceipt(arg0 context.Context, arg1 string, arg2 int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendEmailReceipt", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}

// SendEmailReceipt indicates an expected call of SendEmailReceipt.
func (mr *MockEmailSenderMockRecorder) SendEmailReceipt(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendEmailReceipt", reflect.TypeOf((*MockEmailSender)(nil).SendEmailReceipt), arg0, arg1, arg2)
}
